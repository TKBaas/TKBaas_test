...
function preselect(p_key,c_key,a_key) {
    var index;
...
var citys;
var areas;
//var citys_index_str="0_"+index;
citys = dsy.Items["0_"+index];
var cl = citys.length;
var c_index;
for (j = 0; j < cl; j++) {
    if (c_key == citys[j]) {
...
if (c_index < citys.length) {
    document.getElementById(s[1]).selectedIndex = c_index + 1;
change(2);
}
areas = dsy.Items["0_"+index+"_"+c_index];
var al = areas.length;
var a_index;
for (k = 0; k < al; k++) {
    if (a_key == areas[k]) {
...
if (a_index < areas.length) {
    document.getElementById(s[2]).selectedIndex = a_index + 1;
change(3);
}
//以上是修改代码-----------end
}
